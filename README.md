# Nanome - Conformer Generator

A Nanome Plugin to generate conformers for a selected molecule using RDKit
...
To run Conformer Generator in a Docker container:
...
## Development
To run Conformer Generator with autoreload:
